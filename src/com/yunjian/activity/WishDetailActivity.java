				...
				if(result != null){
					if(queryId.equals(WishService.GetWishDetail)){
					    ...
					    if(map.get("weixin").toString().equals("")){
					    	...
					    	wechatTextView.setText(map.get("weixin").toString());
					    }
					    personname.setText(map.get("username").toString());
					    if(map.get("gender").toString().equals("0.0")){
					    	sexImageView.setImageResource(R.drawable.user_sex_woman);
					    }
					    else if (map.get("gender").toString().equals("2.0")) {
					    	sexImageView.setImageResource(R.drawable.user_sex_secret);
						}
	...
	public void onClick(View arg0) {
        ...
        case R.id.wishdetail_comment_img:
        	if(Utils.user_id.equals("")){
				Intent intent3 = new Intent(WishDetailActivity.this,LoginActivity.class);
				startActivity(intent3);
			}
        	else {
        		InputPopwindow inputPopwindow = new InputPopwindow(this,wish_id,1);
        ...
        case R.id.wishdetail_description_txv:
        	Intent intent3 = new Intent(WishDetailActivity.this,DescriptionDetail.class);
