	...
	public void initView(){
		...
		messageListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				else if(list.get(arg2).get("type").toString().equals("0.0")){}
				else {
					Intent intent1 = new Intent(MessageCenter.this,MessageDetail.class);
					intent1.putExtra("user_id", list.get(arg2).get("another_user_id").toString());
					intent1.putExtra("bookname", list.get(arg2).get("bookname").toString());
